...
MAKE SURE that your device is on any screen BUT the iCloud Lock! The bypass will not complete if so.
...
""")
    ...
    message = "These are the tools for bypassing the iPhone 5s..."
    tk.Label(win, text="These are the tools for bypassing the iPhone 5s...").pack()
...
choosebypass = tk.Label(frame, text="Choose a bypass for the iPhone 5s...", font=("helvetica", 20))
